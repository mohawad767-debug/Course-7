...
void transpose_arr(int** arr1,int **arr2, int R, int C)
{
    for (int i = 0;i < R;i++)
    {
...
int main()
{
    ...
    Fillarr(arr, R, C);
    cout << "The following is a " << R << " * " << C << " ordered array\n";
    Printarr(arr, R, C);

    cout << "The following is a " << R << " * " << C << " Transposed array\n";
    int** arr2 = two_dimnench_arr(R, C);;
    transpose_arr(arr, arr2, R, C);
