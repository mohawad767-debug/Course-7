...
int Rowsum(int** arr, int i, int C)
{
    int sum = 0;
    for (int k = 0;k < C;k++)
    {
...
void SumofRows(vector<int> &sums,int** arr, int R, int C)
{
   

    for (int i = 0;i < R;i++)
    {
        sums.push_back(Rowsum(arr, i, C));
